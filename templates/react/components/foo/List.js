            ...
            {this.props.retrieved &&
              this.props.retrieved['{{{dataContainerName}}}'].map(item => (
                <tr key={item['{{{dataIdName}}}']}>
                  <th scope="row">
                    <Link to={`show/${linkStringForFrontEnd(encodeURIComponent(item['{{{dataIdName}}}']), '{{{name}}}')}`}>
                      {item['{{{dataIdName}}}']}
                    </Link>
                  </th>
{{#each fields}}
...
{{/each}}
                  ...
                  <td>
                    <Link to={`edit/${linkStringForFrontEnd(encodeURIComponent(item['{{{dataIdName}}}']), '{{{name}}}')}`}>
  ...
  pagination() {
    ...
    previous = previous ? paginationStringForFrontEnd(previous, '{{{name}}}') : null;
    next = next ? paginationStringForFrontEnd(next, '{{{name}}}') : null;
    last = paginationStringForFrontEnd(last, '{{{name}}}');
